...
import { AddPlannedPaymentModalComponent } from '../add-planned-payment-modal/add-planned-payment-modal.component';
import { EditPlannedPaymentModalComponent } from '../edit-planned-payment-modal/edit-planned-payment-modal.component';

@UntilDestroy()
@Component({
  selector: 'fpd-planned-payments-table-tab',
  standalone: true,
  imports: [
    CommonModule,
    NzTableModule,
  ...
  templateUrl: './planned-payments-table-tab.component.html',
  styleUrl: './planned-payments-table-tab.component.less',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class PlannedPaymentsTableTabComponent implements OnInit {
