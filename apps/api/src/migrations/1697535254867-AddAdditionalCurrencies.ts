...
export class AddAdditionalCurrencies1697535254867 implements MigrationInterface {
  name = 'AddAdditionalCurrencies1697535254867';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TYPE "public"."currency_enum" RENAME TO "currency_enum_old"`);
    await queryRunner.query(`CREATE TYPE "public"."currency_enum" AS ENUM('840', '980', '978', '203', '191')`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "public"."currency_enum_old" AS ENUM('840', '980', '978')`);
    await queryRunner.query(
