...
export class AddPLNCurrency1697573846754 implements MigrationInterface {
  name = 'AddPLNCurrency1697573846754';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TYPE "public"."currency_enum" RENAME TO "currency_enum_old"`);
    await queryRunner.query(`CREATE TYPE "public"."currency_enum" AS ENUM('840', '980', '978', '203', '191', '985')`);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "public"."currency_enum_old" AS ENUM('840', '980', '978', '203', '191')`);
    await queryRunner.query(
